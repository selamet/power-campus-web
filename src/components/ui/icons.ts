...
export const ICONS: Record<string, string> = {
  ...
  partyPopper:
    '<path d="M5.8 11.3 2 22l10.7-3.79"/><path d="M4 3h.01M22 8h.01M15 2h.01M22 20h.01"/><path d="M22 2 19.76 2.75a2.9 2.9 0 0 0-1.96 3.12c.1.86-.57 1.63-1.45 1.63h-.38c-.86 0-1.6.6-1.76 1.44L12 10"/><path d="M22 13 21.18 12.67c-.86-.34-1.82.2-1.98 1.11c-.11.7-.72 1.22-1.43 1.22H17"/><path d="M11 2 9.66 2.6c-.86.42-1.3 1.4-1.02 2.32c.24.78-.21 1.6-1 1.83L7.14 6.9"/><path d="M3 11 12 20"/>',
};
