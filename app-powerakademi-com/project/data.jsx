/* data.jsx — mock data & shared options */

const LANGUAGES = ['İngilizce', 'Almanca', 'Fransızca', 'İspanyolca', 'İtalyanca', 'Rusça', 'Arapça'];
const LEVELS = ['A1 — Başlangıç', 'A2 — Temel', 'B1 — Orta', 'B2 — Orta-Üstü', 'C1 — İleri', 'C2 — Üst Düzey'];
const GOALS = ['Genel İngilizce', 'Sınav Hazırlık (IELTS/TOEFL)', 'İş İngilizcesi', 'Akademik', 'Konuşma Kulübü', 'YDS / YÖKDİL'];
const COURSES = ['Hafta İçi Sabah', 'Hafta İçi Akşam', 'Hafta Sonu Yoğun', 'Birebir Özel', 'Online Canlı'];
const PAY_METHODS = ['Kredi Kartı', 'Banka Havalesi / EFT', 'Nakit', 'Kapıda Ödeme'];
const CITIES = ['İstanbul', 'Ankara', 'İzmir', 'Bursa', 'Antalya', 'Adana', 'Konya'];
const RELATIONS = ['Anne', 'Baba', 'Eş', 'Kardeş', 'Vasi', 'Kendisi', 'Diğer'];

const STAFF = { name: 'Elif Demir', role: 'Personel', email: 'elif.demir@powerakademi.com', branch: 'Kadıköy Şube' };
...
Object.assign(window, {
  LANGUAGES, LEVELS, GOALS, COURSES, PAY_METHODS, CITIES, RELATIONS,
  STAFF, STUDENTS, ACTIVITY, fmtMoney, fmtDate, STATUS,
});
